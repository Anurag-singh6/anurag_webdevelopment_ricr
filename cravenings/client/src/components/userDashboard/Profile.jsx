...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="ml-2.5 p-2 h-[40vh] mr-2.5 bg-(--color-secondary) border rounded flex gap-10">
        <div>
          <span className="text-(--color-accent) font-bold">Name: </span>
          <span className="text-(--color-text) font-medium">{user.fullname}</span>
        </div>
        <div>
        ...
        <div>
          <span className="text-(--color-accent) font-bold">Mobile Number: </span>
          <span className="text-(--color-text) font-medium">{user.mobileno}</span>
        </div>
