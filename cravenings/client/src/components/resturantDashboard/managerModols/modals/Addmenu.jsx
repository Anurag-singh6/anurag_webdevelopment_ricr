...
const Addmenu = ({ onclose }) => {
  ...
  const [imagePreviws, setImagePreviews] = useState([]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(error);
      toast.error(error.response?.data?.message || "failed to add menu items");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              {imagePreviws.length !== 0 && (
                <div className="mt-3 grid grid-cols-5 gap-1">
                  {imagePreviws.map((itemImg, idx) => (
                    <div
